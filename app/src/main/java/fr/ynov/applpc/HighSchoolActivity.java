...
//Pierre
    ...
    private LinearLayout coordonnees = null;
    ...
    private View.OnClickListener redirect_orientation = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(HighSchoolActivity.this, OrientationActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordonnees = (LinearLayout) findViewById(R.id.ll_highschool_contact);
