...
import fr.ynov.applpc.data.AppLpcDBContract.CVLEntry;

/**
 * Created by clément on 23/02/2016.
 */
public class DataCVLProvider extends CustomDataProvider{

    public DataCVLProvider(Context context){

        this.context = context;
        mOpenHelper = new AppLpcDBHelper(this.context);
        table_colums = new String[]{CVLEntry.COLUMN_TITLE,
                CVLEntry.COLUMN_DATE,
                CVLEntry.COLUMN_CONTENT
        };
        table_name = CVLEntry.TABLE_NAME;
